...
const stripePromise = loadStripe(process.env.REACT_APP_STRIPE_PUBLIC_KEY||"pk_test_51J2X8bSGjIO6Ns88xrooTIVI2IY4dc0CgVBUONJkjyGKyqTvqGsRIvhPmERXYS5BG3pw0vVfbZJETehaCAFVoxpi00aGOIFL0A");
...
export default function PaymentPage(props:any) {
  const [message, setMessage] = useState("");
   const {userId,data} = useSelector((state:State) => state.user)
//    console.log(preUser);
