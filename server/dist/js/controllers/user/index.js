...
exports.changeUserToTeacher =
  exports.deleteUser =
  exports.getUserEmailId =
  exports.getUserId =
  exports.updateUser =
  exports.addUser =
  exports.getIndividualUser =
  exports.getUser =
    void 0;
...
const updateUser = (req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    try {
      ...
      // console.log(body, id);
      const updatedStudent = yield user_1.default.findByIdAndUpdate(
        { _id: id },
        body,
        function (err, result) {
          if (err) {
...
const deleteUser = (req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    try {
      const delete_student = yield user_1.default.findByIdAndRemove(
        req.params.id
      );
...
const changeUserToTeacher = (userId) =>
  __awaiter(void 0, void 0, void 0, function* () {
    const data = yield user_1.default.findByIdAndUpdate(
      { _id: userId },
      { flag: true },
