...
exports.getChapterByCourseId =
  exports.deleteChapter =
  exports.getChapterId =
...
const updateChapter = (req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    try {
      ...
      console.log(body, id);
      const updatedChapter = yield chapter_1.default.findByIdAndUpdate(
        { _id: id },
        body
      );
...
const deleteChapter = (req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    try {
      const delete_chapter = yield chapter_1.default.findByIdAndRemove(
        req.params.id
      );
      const allChapters = yield chapter_1.default.find();
      res.status(200).json({
...
const getChapterByCourseId = (req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    try {
      const {
        params: { id },
